...
// NodeStatsJVMResponse is a representation of a JVM stats, memory pool information,
// garbage collection, buffer pools, number of loaded/unloaded classes
...
// NodeStatsThreadPoolPoolResponse is a representation of a statistics about each thread pool,
// including current size, queue and rejected tasks
